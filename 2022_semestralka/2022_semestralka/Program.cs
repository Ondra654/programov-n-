...
namespace _2022_semestralka
{
    class Program
    {
        static char Menu()
        {
            ...
            do{
                if (coins > 500){
                    Console.WriteLine("Sorry, our worker can exchange maximum amount of 500 Casino coins");
                    Console.Write("How many casino coins do you want to change? ");
                    coins = NumberCheck();
                }if (coins < 1){
                    Console.WriteLine("Minimum amount of Casino coins is 1!");
                    Console.Write("How many casino coins do you want to change? ");
                    coins = NumberCheck();
                }if (coins <= 500){
                    break;
            ...
            int balance = coins;
            Console.WriteLine("Let´s start, actual coins amount is {0}", balance);
            Console.ReadLine();
            char input;
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    ...
                    case 'L':
                        Console.Clear();
                        Console.WriteLine("You exchanged Cosino coins and left casino, there are your results: ");
                        int exchange = balance * 2;
                        Console.WriteLine("{0} with final Casino coins balance: {1}, after exchange: {3}", nickname, balance, exchange);
        ...
        static void Roulette (ref int balance, ref string nickname)//1st row;; 2nd row;;; 3rd rowá
        {
            Console.Clear();
